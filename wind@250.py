...
for i in range(60):
  ...
  m = Basemap(projection='ortho', lon_0=95, lat_0=25)
  cx, cy = m(lon2, lat2)
  m.drawcoastlines(color='white')

  wm_good=np.where(wm < 75, wm, 75)

  tm = m.contourf(cx, cy, wm_good, cmap = cm.RdYlBu_r, levels=np.arange(0, 75.1, 0.1))
  #, levels = np.arange(0, 64, 0.1))
  ...
  plt.title('Wind velocity at 250 hPa 2016/01/'+str(day)+'_'+str(hour_good)+'Z', fontsize=25)
